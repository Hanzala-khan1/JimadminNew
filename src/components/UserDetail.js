...
const UserDetails = ({ showDetails, handleShowDeatils, Data, type = "user" }) => {
    let image;
                                ...
                                <div className="card mb-3" style={{ borderRadius: '.5rem' }}>
                                    <div className="row g-0">
                                        <div className="col-md-4 gradient-custom text-center text-white"
                                            ...
                                            <img src={image ? (image) : "https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava1-bg.webp"}
                                                alt="Avatar" className="img-fluid my-5" style={{ width: '120px', height: "150px" }} />
